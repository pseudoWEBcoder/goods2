...
use app\models\searches\ItemCategoryrySearch;
use Yii;
...
class ItemCategoryController extends Controller
{
    ...
    {
        $searchModel = new ItemCategoryrySearch();
            ...
            */
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => "Create new ItemCategory",
                    'content' => '<span class="text-success">Create ItemCategory success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
    ...
    /**
     * Delete an existing ItemCategory model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing ItemCategory model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
